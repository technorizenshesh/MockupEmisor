...
import com.sefueemisor.SplashAct;
...
public class SessionManager {
    ...
    public static final String PREF_NAME = "BRHSeller";
...
/*
    public static void Logout(String id, Context context) {
        BRHSellerInterface apiInterface = ApiClient.getClient().create(BRHSellerInterface.class);
